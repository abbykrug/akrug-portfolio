...
- Designed a human resources chatbot for Nestle using LangChain and Open AI LLM
- Implemented Retrieval-Augmented Generation (RAG) within in my chain through a FAISS vectorstore. This included uploaded data, splitting, and embedding. Through the process, my program will analyze the user input and add context with a personalized prompt.
- This project gave me invaluable experience, learning the importance and RAG and how to implement it. I also learned how to use the Python Package LangChain to string together the RAG chain and the LLM.
- [Source Code]()
